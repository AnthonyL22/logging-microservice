...
public class LoggerBaseTest {
    ...
    protected void verifyLogOutput(final String messageToVerify) {
        Assert.assertTrue(StringUtils.contains(QherkinLoggerService.getOutMessage(), messageToVerify));
        String assertDateInMessage = StringUtils.remove(QherkinLoggerService.getOutMessage(), "\n");
